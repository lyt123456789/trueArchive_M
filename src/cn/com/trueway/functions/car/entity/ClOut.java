package cn.com.trueway.functions.car.entity;
...
@Entity
@SqlResultSetMapping(name="CarOutResults", 
        entities={ 
            @EntityResult(entityClass=cn.com.trueway.functions.car.entity.ClOut.class,
            	fields={
	            	...
	            	//
					@FieldResult(name="carnumber", column="carnumber"),
					@FieldResult(name="applystartdate", column="applystartdate"),
					@FieldResult(name="applyenddate", column="applyenddate"),
					@FieldResult(name="applyreason", column="applyreason"),
	            	@FieldResult(name="applycomment", column="applycomment"),
					@FieldResult(name="plancarnumber", column="plancarnumber")
...
//	@Transient
//	private Date begin_time;		//发起时间
//	private Date last_time;			//最新办理时间
//	
...
//	}
	...
	public String getPlancarnumber() {
		return plancarnumber;
	}

	public void setPlancarnumber(String plancarnumber) {
		this.plancarnumber = plancarnumber;
	}
