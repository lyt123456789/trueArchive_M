...
public class ImageToPdf {
	...
	public static void main(String[] args) {
		ImageToPdf pt=new ImageToPdf();
		// 单转
		pt.imgToPdf("d:/hello.pdf","d:/7491614_141057681000_2.png");
		
		// 批量
		//pt.t();
	}
	
	public void imgToPdf(String pdfpath, String imgpath)
	{
    ...
    try {   
       ...
       // Font FontChinese = new Font(bfChinese, 12, Font.NORMAL);   
        ...
        for(int i=1;i<=2;i++)
        {
        	Document doc = new Document();
        	//定义输出文件的位置   
            PdfWriter.getInstance(doc, new FileOutputStream("d:/hello"+i+".pdf"));
            //开启文档   
            doc.open(); 
