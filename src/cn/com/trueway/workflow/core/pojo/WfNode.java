...
public class WfNode {
	...
	/**
	 * 节点路由类型：0："单人",1："并行抢占式":2："并行完全式",:3："并行结合式", 4："并行传阅式":5："并行办理式"
	 */
	 ...
	 * 是否办文中走发文  0：否，1：是
	 */ 
	@Column(name="wfn_send_file",length=2)
	private Integer wfn_send_file;
	...
	@Column(name = "WFN_ALLOWFAIR")
	private Integer wfn_allowfair;
	
	@ManyToOne(targetEntity=WfMain.class)
	@JoinColumn(name="WFN_PID")
	private WfMain wfMain;
	
	@Column(name = "WFN_ALLOWPRINT")
	private Integer wfn_allowprint;
	 ...
	 * 附件是否编辑
	 */
	@Column(name = "WFN_ISEDIT")	
	private Integer wfn_isEdit;
	...
	/**
	 * 是否双屏展示内容(左: true; 右测：word文件)
	 */
	@Column(name = "WFN_DOUBLESCREEN")	
	private Integer wfn_doubleScreen;
	
	/**
	 * 红头文件模板内容
	 */
	@Column(name = "WFN_REDTAPETEMPLATE")	
	private String wfn_redtapeTemplate;
	...
	@Column(name="node_allowUpload")
	private String node_allowUpload;//允许上传附件
	...
	@Column(name = "ISATTACHNAMEASTITLE")
	private Integer wfn_isAttachAsTitle;	//是否附件名称作为标题
	...
	@Column(name = "WFN_ZWTEMSEL")
	private String wfn_zwTemSel;		//是否允许选择正文模板
	 ...
	 * 参与排序节点
	 */
	@Column(name="WFN_CHILD_NODEIDS")
	private String wfn_child_nodeIds;
	...
	public Integer getWfn_send_file() {
		return wfn_send_file;
	}

	public void setWfn_send_file(Integer wfn_send_file) {
		this.wfn_send_file = wfn_send_file;
	}
	...
	public Integer getWfn_allowfair() {
		return wfn_allowfair;
	}

	public void setWfn_allowfair(Integer wfn_allowfair) {
		this.wfn_allowfair = wfn_allowfair;
	}
	...
	public Integer getWfn_allowprint() {
		return wfn_allowprint;
	}

	public void setWfn_allowprint(Integer wfn_allowprint) {
		this.wfn_allowprint = wfn_allowprint;
	}
	...
	public Integer getWfn_isEdit() {
		return wfn_isEdit;
	}

	public void setWfn_isEdit(Integer wfn_isEdit) {
		this.wfn_isEdit = wfn_isEdit;
	}
	...
	public Integer getWfn_doubleScreen() {
		return wfn_doubleScreen;
	}

	public void setWfn_doubleScreen(Integer wfn_doubleScreen) {
		this.wfn_doubleScreen = wfn_doubleScreen;
	}

	public String getWfn_redtapeTemplate() {
		return wfn_redtapeTemplate;
	}

	public void setWfn_redtapeTemplate(String wfn_redtapeTemplate) {
		this.wfn_redtapeTemplate = wfn_redtapeTemplate;
	}
	...
	public String getIsBigNum() {
		return isBigNum;
	}

	public void setIsBigNum(String isBigNum) {
	...
	public Integer getWfn_isAttachAsTitle() {
	    return wfn_isAttachAsTitle;
	}

	public void setWfn_isAttachAsTitle(Integer wfn_isAttachAsTitle) {
	    this.wfn_isAttachAsTitle = wfn_isAttachAsTitle;
	}
	...
	public String getWfn_child_nodeIds() {
		return wfn_child_nodeIds;
	}

	public void setWfn_child_nodeIds(String wfn_child_nodeIds) {
		this.wfn_child_nodeIds = wfn_child_nodeIds;
	}
	...
	public String getNode_allowUpload() {
		return node_allowUpload;
	}

	public void setNode_allowUpload(String node_allowUpload) {
		this.node_allowUpload = node_allowUpload;
	}

	public String getWfn_zwTemSel() {
		return wfn_zwTemSel;
	}

	public void setWfn_zwTemSel(String wfn_zwTemSel) {
		this.wfn_zwTemSel = wfn_zwTemSel;
	}
