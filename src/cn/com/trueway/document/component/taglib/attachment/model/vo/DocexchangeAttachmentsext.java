...
//@Entity
//@Table(name = "DOCEXCHANGE_ATTACHMENTSEXT")
public class DocexchangeAttachmentsext implements java.io.Serializable {
	...
	/** default constructor */
	public DocexchangeAttachmentsext() {
	}

	/** minimal constructor */
	public DocexchangeAttachmentsext(String docguid, String filename,
