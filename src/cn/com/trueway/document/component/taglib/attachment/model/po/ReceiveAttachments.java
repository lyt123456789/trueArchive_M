...
import cn.com.trueway.document.component.taglib.attachment.model.vo.DocexchangeAttachments;
 ...
 */
@Entity
@Table(name = "OA_RECDOC_ATTACHMENTS")
public class ReceiveAttachments  implements java.io.Serializable {
	...
	/** default constructor */
	public ReceiveAttachments() {
	}

	public ReceiveAttachments(DocexchangeAttachments docAttachments) {
	...
	/** full constructor */
	public ReceiveAttachments(String docguid, String filename,
