 ...
 */
@Entity
@Table(name="T_ARCHIVE_STRUCTURE")
public class EssStructure {
	@Id
	@GeneratedValue(strategy=GenerationType.SEQUENCE,generator="SEQ_ARCHIVE_STRUCTURE")
	@SequenceGenerator(name="SEQ_ARCHIVE_STRUCTURE",sequenceName="SEQ_ARCHIVE_STRUCTURE",allocationSize=1)
	@Column(name="ID")
	private Integer id;
