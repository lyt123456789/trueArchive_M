...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<link href="${ctx}/dwz/style/css/ued.demo.css" rel="stylesheet" type="text/css" />
		...
		<script type="text/javascript">
	        function initTree(){
		    	 $("#black").treeview({
				 	url: "departmentTree_getContent.do?type=${type}&timestamp="+ new Date().getTime()+"&mc="+encodeURI(encodeURI('${mc}'))
			     });
	        }
	        function sousuo(){
	        	var name=$('#mc').val();
	        	...
	        	$("#black").treeview({
				 	url: "departmentTree_getContent.do?type=${type}&timestamp="+ new Date().getTime()+"&mc="+encodeURI(encodeURI(name))
			    });
	        }
