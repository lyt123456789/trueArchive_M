...
/*
 * savedocUrl:保存doc文件的方法
 * fileName:上传的文件名
 * */
function saveFileToUrl(savedocUrl,fileName)
{	
	if(TANGER_OCX_bDocOpen)
	{
		...
		return TANGER_OCX_OBJ.saveToURL(savedocUrl,//提交到的url地址
		"file",//文件域的id，类似<input type=file name=upLoadFile 中的name
		"fileType="+fileType+"&fileFileName="+fileName,          //与控件一起提交的参数如："p1=a&p2=b&p3=c"
