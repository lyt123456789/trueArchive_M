 ...
 */
function openCommentDialog(commentObjId,commentId,instanceId,addAbled,deleteAble,updateAble,qianpiAble,recordTimeAble,handWriteAble,processLinkAble){
	...
	url = url + '?d='+Math.random()+'&commentObjId=' + commentObjId + '&comment.id=' + commentId + '&currentStepId=' + stepUid + '&comment.instanceId=' + instanceId + '&addAbled=' + addAbled +'&updateAble=' + updateAble + '&deleteAble=' + deleteAble+'&qianpiAble='+qianpiAble+'&processLinkAble='+processLinkAble;
	var commentInputs = document.getElementById(commentObjId).getElementsByTagName('input');
	var examineAble = commentInputs['examineAble'].value;
	if (examineAble==="true"){
