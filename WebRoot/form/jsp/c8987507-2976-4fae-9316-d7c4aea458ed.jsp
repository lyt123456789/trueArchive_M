...
<strong>南通市农业委员会文件传阅批办单</strong>
</p>
<br/>
<br/>
<table  width="819"   align="center">
<tr>
        <td  width="154px"   colspan="2" valign="middle" style="height:30px;font-size:18px;text-align:center;"  ></td>
	  	<td width="250px"  colspan="2" style="font-size:18px;" valign="middle" align="center">
	  		
	  </td>
	  <td   valign="middle" colspan="2" width="195px" style="font-size:18px;text-align:center;" > 办理时限：</td>
	  <td width="195px" colspan="2" style="font-size:18px;" valign="middle" align="center">
	  	<input type="text" id="blsx" name="blsx" style="border:0px;border-bottom:1px #cccccc dotted;line-height:22px;width:150px;line-height:17px;"  /></td>
		
</tr>
</table>
<table  style="margin-top:5px;" width="819" class="infotan" align="center">
	<tr>
	...
	<tr>
        <td  width="154px"   colspan="2" valign="middle" style="font-size:18px;text-align:center;"  >标题</td>
 		...
 		<tr>
 			...
 			<td  width="250px" colspan="4" valign="top" style="font-size:18px;border-bottom:none;">拟办意见：</td>
 			</tr>
 	<tr>
		<td  width="154px" height="72" valign="middle" style="font-size:18px;text-align:center;">朱进华 </td>
		 
		   <td   width="250px" colspan="3" valign="middle" align="center" style="font-size:18px;text-align:center;">
		  <input  type="text" id="zjhdate" name="zjhdate" style="line-height:18px;width:95px;" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" />
		  </td>
		   <td  width="250px" colspan="4" rowspan="2" style="font-size:18px;border-top:none" valign="middle" align="center">
	...
	<tr>
		<td  width="154px" height="72" valign="middle" style="font-size:18px;text-align:center;">王进</td>
	...
	<tr>
		<td  width="154px"  height="72" valign="middle" style="font-size:18px;text-align:center;">严新民</td>
		  
		   <td   width="250px" colspan="3" valign="middle" align="center"style="font-size:18px;text-align:center;">
		  <input  type="text" id="yxmdate" name="yxmdate" style="line-height:18px;width:95px;" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" />
		  </td>
		   <td width="250px" colspan="4" valign="top" style="font-size:18px;border-bottom:none;">阅批意见：</td>
	</tr>
	<tr>
		<td  width="154px"  height="72" valign="middle" style="font-size:18px;text-align:center;">范袁斌</td>
		  
		   <td   width="250px" colspan="3" valign="middle" align="center" style="font-size:18px;text-align:center;">
		  <input  type="text" id="fybdate" name="fybdate" style="line-height:18px;width:95px;" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" />
		  </td>
		   <td width="250px" colspan="4" rowspan="7" style="font-size:18px;border-top:none" valign="middle" align="center">
		
		  		
		  </td>
	</tr>
	<tr>
		<td  width="154px" height="72" valign="middle" style="font-size:18px;text-align:center;">王融荣</td>
	...
	<tr>
		<td  width="154px" height="72" valign="middle" align="center" style="font-size:18px;text-align:center;">孙建坤</td>
	...
	<tr>
		<td width="154px"   height="72" valign="middle" style="font-size:18px;text-align:center;">冯亚军</td>
	...
	<tr>
		<td  width="154px"  height="72" valign="middle" style="font-size:18px;text-align:center;">严汉平</td>
	...
	<tr>
		<td  width="154px" height="72" valign="middle" style="font-size:18px;text-align:center;">张庆国</td>
	...
	<tr>
		<td  width="154px" height="72" valign="middle" style="font-size:18px;text-align:center;">张进</td>
	...
	<tr>
		<td width="154px"  height="72" valign="middle" style="font-size:18px;text-align:center;">崔恒友</td>
	...
	<tr>
		<td width="154px"  height="72" valign="middle" style="font-size:18px;text-align:center;">严士平 </td>
	...
	<tr>
		<td  width="154px" height="72" valign="middle" style="font-size:18px;text-align:center;">邹美华</td>
	...
	<tr>
		<td width="154px"  height="72" valign="middle" style="font-size:18px;text-align:center;">顾彬 </td>
	...
	<tr>
		<td width="154px"  height="72" valign="middle" style="font-size:18px;text-align:center;">刘红娟 </td>
