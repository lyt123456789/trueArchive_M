...
<body>
	<div class="warp">
		<table class="infotan" width=819px cellspacing="0" align="center" style="border-top:2px solid black;">
			...
			<td  style="border:2px solid black;border-right:none;font-size:12px;color:black;border-left:none;border-top:none;">第<input style="width:100px;" id="hao" name="hao"  value=""/>号</td>
            ...
            <td  style="border:2px solid black;border-right:none;font-size:12px;color:black;border-left:none;border-top:none;">爆印份数：<input style="width:100px;" id="byfs" name="byfs"  value=""/></td>
			</tr>
			<tr>
