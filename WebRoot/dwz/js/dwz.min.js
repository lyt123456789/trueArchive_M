...
function initLayout() {
	...
	$(".mainContainer").height($(window).height() - $(".top").height()-65);
	
	var iContentH = $(window).height() - $(".top").height();
	$("#container").width(iContentW);
	$("#container").height(iContentH).find("[layoutH]").layoutH();
	$(".tabsPageContent").height($("#container").height()-$(".tabsPageHeader").height()-35).find("[layoutH]").layoutH();
	$("#container").height(iContentH - 34).find("[layoutH]").layoutH();
	$("#sidebar, #sidebar_s .collapse, #splitBar, #splitBarProxy").height(
			iContentH - 34);
	$('#mainframe').height($(".tabsPageContent").height());  
	$("#taskbar").css( {
...
function navTabAjaxDone(json) {
	...
	if (json.statusCode == DWZ.statusCode.ok) {
		...
		if ("closeCurrent" == json.callbackType) {
			...
			navTab.getCurrentPanel().find(":input[initValue]").each(
					function() {
