...
! function (a) {
 ...
 $.validator.setDefaults({ 
            highlight: function(ele) { 
                var box = $(ele).closest("tr").length ? $(ele).closest("tr") : $(ele).closest(".tw-form-item");

                box.removeClass("tw-has-success").addClass("tw-has-error") 
            },
            success: function(ele) { 
                var box = $(ele).closest("tr").length ? $(ele).closest("tr") : $(ele).closest(".tw-form-item");

                box.removeClass("tw-has-error").addClass("tw-has-success") 
            }, 
            errorElement: "span", 
            errorPlacement: function(ele, inp) { 
                ele.appendTo(inp.is(":radio") || inp.is(":checkbox") ? inp.parent().parent() : inp.parent()) 
            }, 
            errorClass: "tw-help-block"
        })
