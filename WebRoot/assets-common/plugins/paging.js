...
function startPaging(MaxIndex,pageSize,selectIndex,sortStr,skipUrl,submitForm,innerObj){
	...
	for(var j=paging.startpage;j<=paging.endpage;j++){
		var selStyle='margin-right:2px;cursor:pointer;';
		if(j==selectIndex)selStyle='tw-active';
		selectStr+="<li class='"+selStyle+ "' onclick='paging.selectPage("+j+")'><a href='javascript: void(0)'>"+j+"</a></li>";
	}
//	if(selectStr.length>0&&selectStr!=''){
//		selectStr=selectStr.substr(0,selectStr.length-1);
//	}
	...
	//设置首页上一页链接-可选可删可修改-onclick事件、id名不能改变
	var startlast="<li id='first_sp_page' onclick='paging.startPage()'><a href='javascript: void(0)'>首页</a></li><li id='last_sp_page' onclick='paging.lastPage()'><a href='javascript: void(0)'>上页</a></li>";

	//设置下一页末页链接-可选可删可修改-onclick事件、id名不能改变
	var endnext="<li id='next_sp_page' onclick='paging.nextPage()'><a href='javascript: void(0)'>下页</a></li><li id='end_sp_page' onclick='paging.endPage()'><a href='javascript: void(0)'>末页</a></li>";

	//设置GO链接-可选可删可修改-onclick事件、id名不能改变
	var go="<span>跳转到第</span><input class='tw-form-text' id='go_t' type='text' /><span>页</span><input type='button' value='GO' class='tw-page-go-btn' onclick=\"return paging.goPage('go_t')\"/>";
	...
	var pageStr = '<div class="tw-pagination">'
		+'<span class="tw-page-info">'
		+ allInfo
		+'</span>'
		+'<ul class="tw-page-list">'
		+startlast
		+selectStr
		+endnext
		+'<li class="tw-page-go">'
