...
function initLayout(){
	...
	var _layoutH = _heightTop + _heightFoot + _heightHead + 30;
...
(function($){
	$.fn.fixTable = function(options){
		return this.each(function(){
			...
			thead.wrap("<div class='wf-fixtable-header' style='width:" + (tlength ) + "px;'><div class='wf-fixtable-thead' style='width:" + (tlength ) + "px;'><table id='main'  style='width:" + (tlength - gdz) + "px;'></table></div></div>");
			...
			tbody.wrap("<div class='wf-fixtable-scroller'" + layoutStr + " style='width:" + (tlength) + "px;'><div class='wf-fixtable-tbody'><table style='width:" + (tlength - gdz) + "px;'></table></div></div>");
