...
function startPaging(MaxIndex,pageSize,selectIndex,sortStr,skipUrl,submitForm,innerObj){
	...
	selectStr+=" 当 前 第 <li class='wf-active' onclick='paging.selectPage("+selectIndex+")'><a href='javascript: paging.selectPage("+selectIndex+")'>"+selectIndex+"</a></li> 页 ";
//	if(selectStr.length>0&&selectStr!=''){
//		selectStr=selectStr.substr(0,selectStr.length-1);
//	}
	//设置下拉列表框链接-可选可删可修改-onclick事件不能改变
	...
	var startlast="<li id='last_sp_page' onclick='paging.lastPage()'><a href='javascript: paging.lastPage()'>上一页</a></li>";
	...
	var endnext="<li id='next_sp_page' onclick='paging.nextPage()'><a href='javascript: paging.nextPage()'>下一页</a></li>";
	//设置GO链接-可选可删可修改-onclick事件、id名不能改变
