...
(function($){
	...
	$.fn.classBuild=function(options){
		return $(this).each(function(){
			...
			var params=$.extend(defaults,options);
			var $this=$(this);
			var items=$(params.el,$this),i=0,l=items.size()-1;
			var autoTimer,curro=0;
	...
	$.fn.nHover=function(options){
		return $(this).each(function(){
			...
			var params=$.extend(defaults,options);
			var $this=$(this);
			var items=$(params.el,$this);
			items.each(function(){
				$(this).bind(params.trigger,function(e){
					if(!!params.hover) $(this).addClass(params.hover);
					if(!!params.callBack) params.callBack.call($(this),e);
				}).bind(params.untrigger,function(e){
					if(!!params.hover) $(this).removeClass(params.hover);
					if(!!params.out) $(this).addClass(params.out);
					if(!!params.uncallBack) params.uncallBack.call($(this),e);
				});
			});
		});
	}
