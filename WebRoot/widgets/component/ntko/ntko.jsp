<%@ page language="java" pageEncoding="UTF-8" %>
 <object id="TANGER_OCX" classid="clsid:6AA93B0B-D450-4a80-876E-3909055B0640" codebase="${pageContext.request.contextPath}/widgets/component/ntko/ofctnewclsid.cab#version=5,0,2,7" width="100%">
    ...
    <span STYLE="color:red">不能装载文档控件。请在浏览器选项中检查浏览器的安全设置。</span>
</object>
<script type="text/javascript">
	document.getElementById("TANGER_OCX").height=screen.availHeight-85;
</script>
