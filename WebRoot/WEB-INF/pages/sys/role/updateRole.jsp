		...
		<form id="roleFrom" action="" method="post" class="tw-form tw-form-horizontal-lg">
			...
			<div class="tw-form-item">
				...
				<div class="tw-form-field">
					<input name="roleName" id="roleName" type="text" maxlength="100" value="${role.roleName }" class="textInput width_205"/>
				</div>
			</div>
		    <div class="tw-form-item">
              	<label class="tw-form-label">排序号：</label>
		        <div class="tw-form-field">
		         	<input name="roleSort" id="roleSort" type="text" maxlength="6" value="${role.roleSort }" class="textInput width_205" />
				</div>
			</div>  
