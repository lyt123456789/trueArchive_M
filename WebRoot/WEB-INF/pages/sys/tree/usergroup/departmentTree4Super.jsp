...
<!--页面独立树状图生成及操作函数-->
<script src="${ctx}/zTree/assets/js/function.zTree.idsadmin.js" type="text/javascript" charset="utf-8"></script>
<!--移动端touch事件-->
<script src="${ctx}/zTree/assets/js/touch.min.js" type="text/javascript" charset="utf-8"></script>
<!--树状图原生样式表-->
<link rel="stylesheet" type="text/css" href="${ctx}/zTree/assets/css/zTreeStyle/zTreeStyleIds.css"/>
<!--原树状图通用样式类-->
<link rel="stylesheet" type="text/css" href="${ctx}/zTree/assets/css/common.css"/>
<!--新版树状图样式-->
<link rel="stylesheet" type="text/css" href="${ctx}/zTree/assets/css/OAzTreeIds.css"/>
...
// 							if(_globalObject.nameList){ //20180531改动
