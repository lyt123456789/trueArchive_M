...
<tr>
 ...
 <td width="80%"><input id="formName" type="text" name="zwkjForm.form_name" size="40" value=""> <span style="color:#C62112 !important;">*</span> </td>
</tr> 
<tr>
 <td class="bgs ls">表单中文名称：</td>
 <td><input id="formCaption" type="text" name="zwkjForm.form_caption" size="40" value=""> <span style="color:#C62112 !important;">*</span></td>
</tr>
<tr> 
...
<tr> 
 ...
 <td class="tdcol">
	 	<input  type="text" name="zwkjForm.insert_table"  id="insert_table" value="" style="width: 350px;height: 22px;float: left !important;"/>
...
<tr> 
 ...
 <td class="tdcol">
	 	<input  type="number" name="zwkjForm.fontSize"  id="fontSize" value="${zwkjForm.fontSize}" style="width: 100px;height: 22px;float: left !important;"/>
		  ...
		  <iframe id="iframe_form" src="${ctx }/form/html/src/basic.html" style="width: 99%;margin: auto;height: 350px;border: 1px dashed #C2C2C2"></iframe>
	...
	<div class="formBar pa" style="bottom:0px;width:100%;">  
			...
			<li>
				<a onclick="viewHTMLCode()" name="CmdView" class="buttonActive" href="javascript:;"><span>编辑HTML源码</span></a></li>
			<li>
				<div class="buttonActive"><div class="buttonContent"><button name="CmdOk" onclick="sub()" type="submit">保存</button></div></div></li>
			<li>
...
<script type="text/javascript">
		...
		function viewHTMLCode(){
			...
			/* var returnvalue=window.showModalDialog("${ctx}/form/html/src/readHTML.jsp?d="+Math.random(),window,'dialogWidth: '+'900'+'px;dialogHeight: '+'600'+'px; status: no; scrollbars: no; Resizable: no; help: no;center:yes;');
			if(returnvalue){
