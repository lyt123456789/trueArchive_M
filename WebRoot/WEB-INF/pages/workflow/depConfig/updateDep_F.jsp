...
<body>
    <div class="tw-layout">
        <div class="tw-container">
			...
			<input type="hidden" id="docXgDepartment.id" name="docXgDepartment.id" value="${docXgDepartment.id}" />
			...
			<table class="tw-table tw-table-form">
				...
				<tr>
					<th>部门名称：</th>
					<td>
						<input type="text" name="docXgDepartment.name" id="docXgDepartment.name" value="${docXgDepartment.name}" class="tw-form-text">
					</td>
				</tr>
				<c:choose>
				...
				<tr>
					<th>自定义部门id：</th> 
					<td>
						<input type="text" name="docXgDepartment.deptGuid" id="docXgDepartment.deptGuid" value="${docXgDepartment.deptGuid}" class="tw-form-text" /> 
					</td>
				</tr>
				</c:when>
				<c:otherwise>
				<tr>
					<th>原始部门名称：</th> 
					<td>
						<input type="text" name="deptName" id="deptName"  value="${deptName}" class="tw-form-text" /> 
						<a class="tw-btn-primary" href="javascript:selDep();"><i class="tw-icon-search"></i> 选择</a>
						<input type="hidden" name="docXgDepartment.deptGuid" id="docXgDepartment.deptGuid"  value="${docXgDepartment.deptGuid}">
					</td>
				</tr>
				</c:otherwise>
				</c:choose>
				<tr>
					<th>排序号：</th>
					<td>
						<input type="text" name="docXgDepartment.orderNum" id="docXgDepartment.orderNum" value="${docXgDepartment.orderNum}" class="tw-form-text" >（排序号越小, 部门展示越靠前）
					</td>
				</tr>
			</table>
			</form>
