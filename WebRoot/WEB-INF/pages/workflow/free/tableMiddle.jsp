...
<body>
	<form id="permitform" method="POST" name="thisForm" action="${ctx }/table_tableMiddle.do?itemId='+src.id+'&type=${type}" >
	...
	<script type="text/javascript">
		...
		function getField(src){
			...
			if(iframe_right.document.getElementById("changeState") &&iframe_right.document.getElementById("changeState").value == "1"){
				window.parent.frames['iframe_right'].location = '${ctx }/table_fieldRight.do?tableId='+src.id+'&itemId=${itemId}&type=${type}&changeState=1';
			}else{
				window.parent.frames['iframe_right'].location = '${ctx }/table_fieldRight.do?tableId='+src.id+'&itemId=${itemId}&type=${type}&changeState=0';
			}
