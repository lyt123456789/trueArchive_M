               	...
               	$.ajax({
   	                ...
   	                data:"id="+itemId+"&type="+departmentOrEmployee,
   	   			    ...
   	   			    success: function(msg){
   	   	   			    parent.document.getElementById('rolediv').innerHTML = 
   	   	   	   			    "<input type='hidden' name='vc_rolename' id='vc_rolename' value='"+itemId+","+msg+"'>"
   	   	   	   			    +"<input type='hidden' name='dore' id='dore' value='"+departmentOrEmployee+"'>";
   	   			    }
               	});
            }
