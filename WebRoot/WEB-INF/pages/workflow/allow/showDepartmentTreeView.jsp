...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body  >
		...
		<table style="width: 100%;border-collapse: collapse;">
			<tr>
				<td style="">
					<div style="padding-left: 20px;padding-top: 10px;overflow: auto;height: 500px;" >
						<a href="${pageContext.request.contextPath}/departmentTree_showDepartmentTree_allow.do" style="text-decoration: none;">刷新</a>
