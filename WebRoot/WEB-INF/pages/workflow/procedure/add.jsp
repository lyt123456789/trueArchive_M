...
<body > 
	...
	<form id="form1" method="POST" name="thisForm" action="${ctx }/form_addForm.do">
			...
			<table class="infotan" width="100%">
				<tr>
				 ...
				 <td width="80%"><input type="text" name="procedurename" id="" size="40"/></td>
				</tr> 
				<tr>
				 <td width="20%" class="bgs ls">存储过程中文名称：</td>
				 <td width="80%"><input type="text" name="pcname" id="" size="40"/></td>
				</tr> 
				<tr>
				...
				<tr>
				 ...
				 <td width="80%">
				 	<textarea style="width: 80%;height: 300px;" name="paramcontent"></textarea>
	...
	<script type="text/javascript">
		...
		function sub(){
			...
			g.g('form1').action='${ctx }/procedure_add.do';
			g.g('form1').submit();
		};
		//测试存储过程
		function testPro(){
