...
<div class="wf-layout">
	<div class="wf-list-top">
		<div class="wf-search-bar" style="padding: 20px 20px 15px 5px">
			<form name="pendlist"  id="pendlist" action="${ctx }/monitor_getExceedPendingList2ForDept.do?a=Math.random();" method="post" style="display:inline-block;">
	...
	<script type="text/javascript">
		window.onload=function(){ 
			...
			skipUrl="<%=request.getContextPath()%>"+"/monitor_getExceedPendingList2ForDept.do";			//提交的url,必须修改!!!*******************
	...
	<script type="text/javascript">
	/* function sendMsg(userIds,intervalDate,processTitle){
			$.ajax({  
				url : '${ctx}/monitor_sendMsgForUnresolved.do',
				type : 'POST',   
				cache : false,
				data:{"userIds":userIds,"intervalDate":intervalDate,"processTitle":processTitle},
				async : false,
				error : function() {  
