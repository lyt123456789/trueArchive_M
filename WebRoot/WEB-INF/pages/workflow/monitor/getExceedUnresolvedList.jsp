...
<div class="wf-layout">
	<div class="wf-list-top">
		<div class="wf-search-bar" style="padding: 20px 20px 15px 5px">
			<form name="pendlist"  id="pendlist" action="${ctx }/monitor_getExceedUnresolvedList2.do?a=Math.random();" method="post" style="display:inline-block;">
	...
	<div class="wf-list-wrap">
		...
		<form id="thisForm" method="POST" name="thisForm" action="${ctx }/monitor_getExceedPendingList2.do" >
	...
	<script type="text/javascript">
		window.onload=function(){ 
			...
			skipUrl="<%=request.getContextPath()%>"+"/monitor_getExceedUnresolvedList2.do";			//提交的url,必须修改!!!*******************
