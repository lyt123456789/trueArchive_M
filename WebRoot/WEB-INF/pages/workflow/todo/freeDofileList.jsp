...
<body>
 <div class="pageHeader" >
	<form name="freeDofileList" id="freeDofileList" action="${ctx }/table_getFreeDofileList.do" method="post">
		...
		<table  class="searchContent" >
		 <tr>
			<td valign="top" style="text-align: left;">
	 					事项:
	 					&nbsp;
	 					<select id="sel_tagTable" onchange="choose()"  width="300px">
	 					<!-- 
...
<form id="thisForm" method="POST" name="thisForm" action="${ctx }/table_getFreeDofileList.do" >
	<div id="w_list_print">
...
function choose(){
 ...
 window.onload=function(){ 
		//获得后台分页相关参数-必须
		skipUrl="<%=request.getContextPath()%>"+"/table_getFreeDofileList.do";			//提交的url,必须修改!!!*******************
