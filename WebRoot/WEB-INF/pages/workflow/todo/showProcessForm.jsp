    	...
    	<div style="display: none;">
    	  <%
    		if(js!=null){
	 			for(int i=0;i<js.size();i++){
	 				%>
	 				  <trueway:att onlineEditAble="false" id='<%=(instanceId+js.getString(i))%>' docguid='<%=(instanceId+js.getString(i))%>' showId='<%=(js.getString(i)+"show")%>'   ismain="true" downloadAble="true" uploadAble="false" deleteAble="false" previewAble="true" tocebAble="false" toStampAble="false" openBtnClass="icon-add" otherBtnsClass="icon-help" uploadCallback="loadCss" deleteCallback="loadCss"/>
	 				<%
	 			}
	 		}
    	%>
