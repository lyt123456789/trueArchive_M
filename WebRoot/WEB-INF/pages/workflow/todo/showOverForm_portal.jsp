  	...
  	<body onload="init();" style="overflow:hidden;background-color:#989898">
    	...
    	<div class="wrap" style="margin:0">
      		...
      		<div class="header">
		        ...
		        <div class="zw1" onclick="PrintPDF(0);"><img src="${ctx}/assets-common/newImage2/dy.png"><a href="">打印</a></div>
		        <div class="zw1" style="right:138px;width:122px;" onclick="PrintCurPage();"><img src="${ctx}/assets-common/newImage2/dy.png"><a href="">打印当前页</a></div>
          			...
          			<div class="cg_info jQtabcontent" style="margin-top:46px">
            			<div class="fj_load" style="overflow-y: hidden;">
							...
							<c:forEach items="${fjAtts}" var="fjAtt">
              				...
              				<div class="biaoge">
              					<iframe height="100%" id="lcbox" style="padding:0px;margin:0px;display:none;position:absolute;left:0;top:40px;z-index:9;width:100%;height:85%;border-width:0px 1px 1px 0px;border-style:solid;border-color:#B8D0D6;position: fixed;left: 0;right: 0;margin: 0 auto;" src="${ctx}/table_getWfps.do?instanceId=${instanceId}&workFlowId=${workFlowId}&a=Math.random()"></iframe>
								<c:choose>
									<c:when test="${(isFirst == true || isCy == true || (stepIndex=='1' && cType !='1')) && (isWriteNewValue != false) && (finstanceId==null || finstanceId=='' )}">
										<form target="frame_nr" id="form_nr" method="post" action="${ctx}/pdfocx/1.jsp?usbkey=${usbkey}&sealurl=${sealurl}&ischeck=${ischeck}&workFlowId=${workFlowId}&formId=${formId}&oldFormId=${oldFormId}&processId=${processId}&instanceId=${instanceId}&nodeId=${nodeId}&webId=${webId}&userId=${userId}&loginname=${loginname}&isWriteNewValue=false&allInstanceId=${allInstanceId}&atts=''&isOver=${isOver}">
										</form>
										<iframe name="frame_nr" id="frame1"  class="frame1" frameborder="auto" marginheight="0"  marginwidth="0" border="0" style="height:88%;width:100%;border-width:0px 1px 1px 0px;border-style:solid;border-color:#B8D0D6;background-color: #989898;position: fixed;left: 0;right: 0;margin: 0px auto;" src=""></iframe>
									</c:when>
									<c:otherwise>
										<form target="frame_nr" id="form_nr" method="post" action="${ctx}/pdfocx/1.jsp?usbkey=${usbkey}&sealurl=${sealurl}&ischeck=${ischeck}&workFlowId=${workFlowId}&formId=${formId}&oldFormId=${oldFormId}&processId=${processId}&instanceId=${instanceId}&nodeId=${nodeId}&webId=${webId}&userId=${userId}&loginname=${loginname}&isWriteNewValue=${isWriteNewValue}&newInstanceId=${newInstanceId}&newProcessId=${newProcessId}&allInstanceId=${allInstanceId}&atts=&isOver=${isOver}">
										</form>
								 		<iframe name="frame_nr" id="frame1"  class="frame1" frameborder="auto" marginheight="0"  marginwidth="0" border="0" style="height:88%;width:100%;border-width:0px 1px 1px 0px;border-style:solid;border-color:#B8D0D6;background-color: #989898;position: fixed;left: 0;right: 0;margin: 0px auto;" src=""></iframe>
							 		</c:otherwise>
								</c:choose>
      		...
      		<div class="nav fl" style="z-index:40;position:absolute;width:100px;margin-top:40px;">
       		...
       		<div class="nav2 fl" style="margin-top:40px;position:absolute;z-index:40;right:0;min-height: 800px;width:110px;">
				<div class="list">
 						<ul class="yiji">
   						<li>
   							<a href="#" class="inactive inactives" style="width:100px;">操作</a>
     							<ul style="display: inline;">
        							...
        							<c:if test="${favourite != '1'}">
        								<li onclick="javascript:addCollection();"><i class="iconfont iconfont-starton"></i><a href="#">收藏</a></li>
        							</c:if>
