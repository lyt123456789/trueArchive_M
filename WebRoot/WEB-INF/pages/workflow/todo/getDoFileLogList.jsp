...
<div class="wf-layout">
	<div class="wf-list-top">
		<div class="wf-search-bar" style="position: relative;">
		  	<form name="doItemList"  id="doItemList" action="${ctx }/table_getDoFileLogList.do?laterSearch=1" method="post" style="display:inline-block;">
		  	...
		  	<form name="doItemListH"  id="doItemListH" action="${ctx }/table_getDoFileLogList.do?laterSearch=1" method="post" style="display:none;">
				<input type="hidden" name="isPortal" value="${isPortal}"/>
				<input type="hidden" name="laterSearch" value="${laterSearch}"/>
				<input type="hidden" name="favourite" value="${favourite}"/>
				<input type="hidden" name="isShowExp" value="${isShowExp}"/>
			...
			<div id="high-search" style="height:317px;background-size: cover;">
	...
	<div class="wf-list-wrap">
		...
		<form id="thisForm" method="POST" name="thisForm" action="${ctx}/table_getDoFileLogList.do" >
...
<script type="text/javascript">
		window.onload=function(){ 
			//获得后台分页相关参数-必须
			skipUrl="<%=request.getContextPath()%>"+"/table_getDoFileLogList.do";			//提交的url,必须修改!!!*******************
...
<script type="text/javascript">
	...
	function openForm(processId,itemId,formId,favourite,process_title){
		if(processId!=''){
			 var url = '${curl}/table_openOperateLogList.do?favourite='+favourite+'&processId='+processId+'&itemId='+itemId+'&formId='+formId+'&t='+new Date();
			// openLayerTabs(processId,1200,600,process_title,url);
			 layer.open({
				title:process_title,
				type:2,
				area:['90%','90%'],
