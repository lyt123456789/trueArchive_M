...
<div class="wf-layout">
	<div class="wf-list-top">
		<div class="wf-search-bar" style="width: 720px;height: 30px;">
			...
			<form name="receiveList"  id="receiveList" action="${ctx }/table_getDoFileReceiveList.do?type=1" method="post">
				<table>
					<tr>
						<td class="minWidth">
	...
	<div class="wf-list-wrap">
		<form id="thisForm" method="POST" name="thisForm" action="${ctx}/table_getDoFileReceiveList.do?type=1" >
			<table class="wf-fixtable" layoutH="140">
		    	...
		    	<tr>
					...
					<!-- <th  style="width:25%;">来文单位</th> -->
					<th  style="width:15%;">收文时间</th>
...
<script type="text/javascript">
		window.onload=function(){ 
			//获得后台分页相关参数-必须
			skipUrl="${ctx}/table_getDoFileReceiveList.do?type=1";			//提交的url,必须修改!!!*******************
...
<script type="text/javascript">
	...
	function openReceiveForm2(receiveId){
		...
		if(ret == 'refresh'){
			window.location.href="${ctx}/table_getDoFileReceiveList.do?status=1&type=1";
		}
	}
