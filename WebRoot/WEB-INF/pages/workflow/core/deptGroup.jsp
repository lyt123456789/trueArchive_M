  ...
  <div class="pageContent">
	<div class="tabs" currentIndex="1" eventType="click">
    	...
    	<div class="tabsContent" style="padding:1px 0px 1px 0px !important;">
    				<div id="div2" >
						<iframe id="frame100" name="frame100" class="frame10" frameborder="auto" marginheight="0" marginwidth="0" border="0" style="float:left;width:100%;height:100%;border-width:0px 1px 1px 0px;border-style:solid;border-color:#B8D0D6;" src="${ctx}/table_toDepartmentJsp1.do?routType=${routType}&nodeId=${nodeId}&exchange=1&departmentOrEmployee=0"></iframe>
