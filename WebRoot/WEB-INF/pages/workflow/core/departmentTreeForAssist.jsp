...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body  >
		...
		<table style="width: 100%;border-collapse: collapse;">
			<tr>
				<td style="width:40%;">
					<div style="padding-left: 20px;padding-top: 10px;overflow: auto;height: 270px;border: 1px dashed #C2C2C2 " >
				...
				<td style="">
						...
						<select id="oldSelect" size="20" style="width:100%;height: 270px;border: 1px dashed #C2C2C2" multiple="multiple">
