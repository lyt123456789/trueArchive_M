                   ...
                   <c:forEach var="pm" items="${pmList}">
                       <tr>
                           ...
                           <td >
                                ...
                                <a href="${attList.localation}"><font color="blue">${attList.filename}</font></a>
<%--                                 	<span>${attList.filename}</span>&nbsp;&nbsp;&nbsp;<img src="./dwz/button/dow.png" title="查看" style="cursor:pointer;" onclick="javascript:download('${attList.localation}','${fileDownloadUrl}?name=${attList.filename}&location=${attList.localation}')"/>
 --%>                                </c:forEach>
                           </td>
                       </tr>
                   </c:forEach>
