...
<body>
    <div class="menu">
    	<form id="customStatusform" action="${ctx}/customStatus_add.do" method="post" onsubmit="return checkForm();">
			...
			<input type="hidden" name="customStatus.id" id="customStatus.id" value="${customStatus.id}">
    	    <table class="list" width="100%" targetType="navTab" asc="asc" desc="desc" layoutH="116">
		    	 <tbody id="tbodyid">	
			    	 <tr valign="middle" >
		    	 		...
		    	 		<td align="center" >
		    	 			<input type="text" name="customStatus.vc_key" id="customStatus.vc_key" value="${customStatus.vc_key }" style="height: 22px;width:150px">
		    	 		</td>
		    	 	</tr> 
		    	 	 <tr valign="middle" >
		    	 	 	<td align="right" >
		    	 		...
		    	 		<td align="center" >
		    	 			<input type="text" name="customStatus.vc_value" id="customStatus.vc_value" value="${customStatus.vc_value }" style="height: 22px;width:150px">
		    	 		</td>
		    	 	</tr>
	    		</tbody>
    	    </table>
    ...
    <script type="text/javascript">
	    ...
	    function checkForm(){
			...
			var id = document.getElementById('customStatus.id').value;
			$.ajax({
				url:"${ctx}/customStatus_edit.do",
				type:"post",
				data:{'b_global':b_global,'customStatus.vc_key':key.value,'customStatus.vc_value':value.value,'customStatus.lcid':lcid,'customStatus.id':id},
				async : false,
				cache : false,
				error : function() {
