...
<div class="wf-layout">
	<div class="wf-list-top">
		<div class="wf-search-bar">
			<form name="pendlist"  id="pendlist" action="${ctx }/business_getSendLibrary.do" method="post">
	...
	<div class="wf-list-wrap">
		<form id="thisForm" method="POST" name="thisForm" action="${ctx}/business_getSendLibrary.do" >
			<table class="wf-fixtable" layoutH="140">
		    	...
		    	<c:forEach items="${list}" var="item" varStatus="status">
			    	<tr>
						...
						<td align="left" title="${item.zsdw}">${item.zsdw}</td>
						<td align="left" title="${item.csdw}">${item.csdw}</td>
					</tr>	
		    	</c:forEach>
			</table>
		</form>
...
<script type="text/javascript">
		window.onload=function(){ 
			//获得后台分页相关参数-必须
			skipUrl="<%=request.getContextPath()%>"+"/business_getSendLibrary.do";			//提交的url,必须修改!!!*******************
