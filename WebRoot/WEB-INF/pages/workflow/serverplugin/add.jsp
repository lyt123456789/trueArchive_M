...
<body > 
	<form id="form1" action="${ctx }/form_addForm.do" method="post" enctype="multipart/form-data">
			...
			<table class="infotan" width="100%">
				<tr>
				 ...
				 <td width="80%"><input type="text" name="serverplugincname" id="" size="60"/></td>
				</tr> 
				<tr>
				...
				<tr>
				 ...
				 <td width="80%"><input type="file" name="file" id="" size="60"/></td>
				</tr>
			</table>
	...
	<script type="text/javascript">
		function sub(){
			...
			g.g('form1').action='${ctx }/serverPlugin_add.do';
			g.g('form1').submit();
		};
		function goHistroy(){
