	    ...
	    <div class="tw-usertree-right">
		    <div class="tw-usertree-box clearfix" id="user_tree_box">
				...
				<div class="tw-usertree-select">
				    <div class="tw-mod">
					    <div class="tw-hd">已选联系人<span>(<b id="countNum">0</b>)</span><span class="fr" onclick="delAll('delAllObj')">全部移除</span></div>
						<div class="tw-bd">
							<div class="JS_scroll">
