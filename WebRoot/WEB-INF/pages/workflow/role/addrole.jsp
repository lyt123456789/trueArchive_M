...
<tr>
 ...
 <td width="80%"><input type="text" name="employeeRole.roleName" id="roleName" size="40"/></td>
</tr> 
<tr>
 <td class="bgs ls">排序号：</td>
 <td><input type="text" name="employeeRole.zindex" id="sortId" size="40"/><font color="red">（注：按数值大小倒序）</font></td>
</tr>
</table>
				...
				if(teamName == ""){
				    ...
				    if(!reg.test(sortId)){
						...
						if(obj){
							...
							alert('数据保存中,请耐心等待。。。');
							document.getElementById('form1').action='${ctx}/employeeRole_addEmployeeRole.do';
