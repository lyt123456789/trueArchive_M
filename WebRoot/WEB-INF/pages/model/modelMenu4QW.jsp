	...
	layui.extend({
		...
		dtree.on("chooseDone('demoTree')" ,function(obj){
			 ...
			 for(var i=0;i<params.length;i++){
				 var getStructId = params[i].basicData;
				 var treeNodeId = params[i].id;
				 if(getStructId!=null&&getStructId!="0"&&getStructId!="-1"){
					 str+=treeNodeId+",";
				 }
			 }
			 if(str!=null&&str!=""){
			 ...
			 parent.document.getElementById("treeNodeIds").value=str;
		});
