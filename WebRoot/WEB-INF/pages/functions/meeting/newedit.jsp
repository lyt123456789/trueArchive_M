...
<head>
	...
	<div style="height:450px; overflow:scroll;" id="div">
		...
		<input type="hidden" name="meetnew.id" value="${meetnew.id}" id="meetnew.id" /> 
			...
			<tbody>
					...
					<td width="75%" colspan="3"><input type="text" style="width: 600px" id="meetingname" name="meetnew.meetingname" maxlength="100" value="${meetnew.meetingname }"/><span style="color: red;">*</span></td>
				</tr>
				<tr>
					<td width="25%" class="bgs ls">通知标题：</td>
					<td width="75%" colspan="3"><input type="text" style="width: 600px" id="newtitle" name="meetnew.newtitle" maxlength="100" value="${meetnew.newtitle }"/></td>
				</tr>
				<tr>
					<td width="25%" class="bgs ls">抬头：</td>
					<td width="75%" colspan="3"><input type="text" style="width: 600px" id="newtt" name="meetnew.newtt" maxlength="100" value="${meetnew.newtt }"/>
					</td>
				</tr>
				<tr>
					<td width="25%" class="bgs ls">通知内容：</td>
					<td width="75%" colspan="3"><input type="text" style="width: 600px" id="newrl" name="meetnew.newrl" maxlength="1000" value="${meetnew.newrl }"/>
					</td>
				</tr>
				<tr>
					<td width="25%" class="bgs ls">落款：</td>
					<td width="75%" colspan="3"><input type="text" style="width: 600px" id="newlk" name="meetnew.newlk" maxlength="100" value="${meetnew.newlk }"/>
					</td>
				</tr>
				<tr>
					<td width="25%" class="bgs ls">时间：</td>
					<td width="75%" colspan="3"><input type="text" style="width: 600px" id="newtime" name="meetnew.newtime" value="${meetnew.newtime }" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"/><font color="red">*</font></td>
				</tr>
				<tr>
					<td width="25%" class="bgs ls">地点：</td>
					<td width="25%" ><input type="text" style="width: 250px" id="arr" name="meetnew.arr" value="${meetnew.arr }" /></td>
					<td width="20%" class="bgs ls">驾驶员：</td>
					<td width="30%" ><input type="text" style="width: 100px;float: left !important;" id="jsy" name="meetnew.jsy" value="${meetnew.jsy }"/>
					<input type="hidden" name="meetnew.jsyid" id="jsyid" value="${meetnew.jsyid }">
				...
				<tr>
					...
					<td width="30%" >
					<input type="radio" name="sbmd" value="0" >否
				...
				<tr>
					...
					<s:hidden theme="simple" id="personid" name="meetnew.personid" value="${meetnew.personid }"/>
			...
			<td width="75%" colspan="3"> 
				...
				<div id="custom-queue" style="margin:0 auto;"></div><br/>
			</td>
			</tr>
			</table>
			<br>
	...
	document.getElementById('dx').value = '${meetnew.dx}';
	document.getElementById('personname').innerHTML = '${meetnew.personname}';
	var sbmd = '${meetnew.sbmd}';
	var obj = document.getElementsByName("sbmd");
	for (var t=0; t<obj.length; t++){
		if(obj[t].value==sbmd){
			obj[t].checked=true;
