...
<div class="wf-layout">
	<div class="wf-list-top">
		<div class="wf-search-bar">
			<form name="lendLingList"  id="lendLingList" action="" method="post" style="display:inline-block;width: 100%;">
			    ...
			    <div class="search">
			  	 <span style="float: left;font-size: 17px;margin-right: 30px;">已创建索引库的节点</span>
	...
	<div class="table" style="overflow: auto;">
		<div>
		    <table cellspacing="0" cellpadding="0">
		        ...
		        <c:forEach items="${indexYesList}" var="data" varStatus="status">
		        	<tr>
		    			<td>
							<input type="checkbox" name="selid" id=""  value="${data[0]}"  >
						</td>
						<td>${data[2]}</td>
						<td>${data[3]}</td>
		    		</tr>
	...
	window.onload=function(){ 
		//获得后台分页相关参数-必须
		skipUrl="<%=request.getContextPath()%>"+"/ftm_showFUllTextIndexYesList.do";			//提交的url,必须修改!!!*******************
	...
	$("#addnum").bind("click",function(){
		...
		$.ajax({
	        ...
	        cache:false,//是否使用缓存
	        dataType:"text",//返回值类型
	        data:{"treeId":"${treeId}","structId":"${structId}","indexName":"${indexName}"},
