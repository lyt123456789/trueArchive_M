	   		...
	   		<div class="add_verify">
	   			<table>
	   				<tr>
	   					...
	   					<td>
	   						<div class="dw">
				        		<input id="btn_name" placeholder="必填" type="text" name="btn_name" value=""/>
				    		</div>
				    	</td>	
	   				</tr>
	   				<tr>
	   					...
	   					<td>
	   						<div class="dw">
	   							<input id="btn_description" placeholder="必填" type="text" name="btn_description" value=""/>
				    		</div>
				    	</td>	
	   				</tr>
	   				<tr>
	   					...
	   					<td>
	   						<div class="dw">
				        		<input id="btn_sort" placeholder="必填" type="text" name="btn_sort" value=""/>
				    		</div>
				    	</td>	
	   				</tr>
   				</table>
