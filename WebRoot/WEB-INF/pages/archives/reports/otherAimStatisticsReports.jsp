	...
	<script type="text/javascript">
		...
		function getData() {
			...
			$.ajax({
		        ...
		        url:"${ctx}/rep_getOtherAimStatisticsReports.do",
		        success:function(result){
		        	...
		        	if(flag == "failed") {
		        		...
		        		for(var i = 0; i < data.length; i++) {
		        			var obj = data[i];
		        			str += "<tr><td align='center'>"+ obj.borrowQtmd + "</td>";
		...
		function exportExcel() {
			...
			document.location.href = "${ctx}/rep_exportOtherAimStatisticsExcel.do?startTime="+startTime+"&endTime="+endTime+"&receivePeople="+receivePeople;
		}
