	...
	<script type="text/javascript">
		...
		function getData() {
			...
			$.ajax({
		        ...
		        url:"${ctx}/rep_getAimStatisticsReports.do",
		        success:function(result){
		        	...
		        	if(flag == "failed") {
		        		...
		        		for(var i = 0; i < data.length; i++) {
		        			var obj = data[i];
		        			str += "<tr><td align='center'>"+ obj.borrowCdmd + "</td>";
		...
		function exportExcel() {
			...
			document.location.href = "${ctx}/rep_exportAimStatisticsExcel.do?startTime="+startTime+"&endTime="+endTime+"&receivePeople="+receivePeople;
		}
	</script>
</html>