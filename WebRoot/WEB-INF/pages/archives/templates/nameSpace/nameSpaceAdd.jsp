	   		...
	   		<div class="add_verify">
	   			<table>
	   				<tr>
	   					...
	   					<td>
	   						<div class="dw">
				        		<input id="esIdentifier" placeholder="必填" type="text" name="esIdentifier" value=""/>
				    		</div>
				    	</td>	
	   				</tr>
	   				<tr>
	   					...
	   					<td>
	   						<div class="dw">
				        		<input id="esCreator" placeholder="必填" type="text" name="esCreator" value=""/>
				    		</div>
				    	</td>	
	   				</tr>
	   				<tr>
	   				...
	   				<tr>
	   					...
	   					<td>
	   						<div class="dw">
	   							<input id="esUrl"  type="text" name="esUrl" value="" placeholder="请填写文件地址信息"/>
				    		</div>
				    	</td>	
	   				</tr>
	   				<tr>
	   					...
	   					<td>
	   						<div class="dw">
	   							<input id="esDescription"  type="text" name="esDescription" value=""/>
				    		</div>
				    	</td>	
	   				</tr>
	   				<tr>
	   					...
	   					<td>
	   						<div class="dw">
	   							<input id="esVersion"  type="text" name="esVersion" value="" placeholder="必填"/>
				    		</div>
				    	</td>	
	   				</tr>
   				</table>
