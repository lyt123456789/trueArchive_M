...
<c:if test="${'3' eq layout}">
	<div><iframe id="frame3" width="100%" frameborder="0" src="${ctx}/dataManage_toStructureDataPage.do?treeId=${treeId}&structureId=${projectStructureId}&projectStructureId=${projectStructureId}&fileStructureId=${fileStructureId}&innerFileStructureId=${innerFileStructureId}&flag=all" class="iframe"></iframe></div>
	<div><iframe id="frame2" width="100%" frameborder="0" src="${ctx}/dataManage_toStructureDataPage.do?treeId=${treeId}&structureId=${fileStructureId}&projectStructureId=${projectStructureId}&fileStructureId=${fileStructureId}&innerFileStructureId=${innerFileStructureId}" class="iframe"></iframe></div>
	<div><iframe id="frame1" width="100%" frameborder="0" src="${ctx}/dataManage_toStructureDataPage.do?treeId=${treeId}&structureId=${innerFileStructureId}&projectStructureId=${projectStructureId}&fileStructureId=${fileStructureId}&innerFileStructureId=${innerFileStructureId}" class="iframe"></iframe></div>
</c:if>
<c:if test="${'2' eq layout}">
	<div><iframe id="frame2" width="100%" frameborder="0" src="${ctx}/dataManage_toStructureDataPage.do?treeId=${treeId}&structureId=${fileStructureId}&projectStructureId=${projectStructureId}&fileStructureId=${fileStructureId}&innerFileStructureId=${innerFileStructureId}&flag=all" class="iframe"></iframe></div>
	<div><iframe id="frame1" width="100%" frameborder="0" src="${ctx}/dataManage_toStructureDataPage.do?treeId=${treeId}&structureId=${innerFileStructureId}&projectStructureId=${projectStructureId}&fileStructureId=${fileStructureId}&innerFileStructureId=${innerFileStructureId}" class="iframe"></iframe></div>
</c:if>
<c:if test="${'1' eq layout}">
<div><div><iframe id="frame1" width="100%" frameborder="0" src="${ctx}/dataManage_toStructureDataPage.do?treeId=${treeId}&structureId=${innerFileStructureId}&projectStructureId=${projectStructureId}&fileStructureId=${fileStructureId}&innerFileStructureId=${innerFileStructureId}&flag=all" class="iframe"></iframe></div></div>
</c:if>
