...
var ctx = "${ctx}";
	layui.extend({
		...
		var commonTree = dtree.render({
		    elem: "#demoTree",
		    url: "${ctx}/dataManage_getSonTreeJson.do",
		    data:dataJson,
		...
		dtree.on("node('demoTree')" ,function(obj){
			...
			if(structureId!="0"&&structureId!="-1"){
				parent.document.getElementById("frame").src='${ctx}/dataManage_toEditDataMainPage.do?structureId='+structureId+'&treeId='+treeId;
			}else if(leaf){
				layer.msg("该节点下未关联结构");
			}
		});  
