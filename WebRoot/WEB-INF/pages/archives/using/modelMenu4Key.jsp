...
<script>
	layui.extend({
		...
		var commonTree = dtree.render({
		    elem: "#demoTree",
		    url: "${ctx}/dataUsing_getSonTreeJson.do",
		    data:dataJson,
		...
		dtree.on("node('demoTree')" ,function(obj){
			...
			if(struc != '0'&&struc != '-1'){
			 	parent.document.getElementById("frame").src='${ctx}/dataUsing_toModelTask4Key.do?treeId='+treeId+'&structId='+struc+'&fatherId='+struc+'&codeId='+codeId+'&type=0&jydId=${jydId}&djdId=${djdId}&zzcdFlag=${zzcdFlag}&openFlag=1';
			}
		});  	
	});
