        ...
        <div class="tw-container">
			...
			<table class="tw-table tw-table-form">
				...
				<tr>
					<th>页面展示值：</th>
					<td>
						<input type="text" name="basicdata.dataName" id="basicdata.dataName" class="tw-form-text">
					</td>
				</tr>
				<tr>
					<th>数据库展示值：</th>
					<td>
						<input type="text" name="basicdata.feilName" id="basicdata.feilName" class="tw-form-text">
					</td>
				</tr>
                <tr>
                    <th>隶属类别名称：</th>
                   <td>
                   		<input type="text" name="basicdata.typeName" id="basicdatatypeName" class="tw-form-text">
                ...
                <tr>
                    <th>隶属类别：</th>
                   <td>
						<input type="text" name="basicdata.type" id="type" class="tw-form-text">
					</td>
                </tr>
                  <tr>
                    <th>排序：</th>
                   <td>
						<input type="text" name="basicdata.numIndex" id="basicdata.numIndex" class="tw-form-text">
					</td>
                </tr>
                <tr>
                    <th></th>
