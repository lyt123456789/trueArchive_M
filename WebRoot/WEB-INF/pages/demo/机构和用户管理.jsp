	...
	<div id="editDiv">
		...
		<div class="wf-list-top">
			<div class="wf-search-bar">
			  <!-- <div style="float: left;font-size: 16px;line-height: 30px;height: 30px;margin-right: 15px;"><i class="fa fa-list-alt"></i>用户列表</div> -->
				<form name="list"  id="list" action="" method="post" style="display:inline-block;width: 100%;">
					<div class="search">
					    <div style="float: left;font-size: 16px;line-height: 30px;height: 30px;margin-right: 15px;">用户列表</div>
    				    ...
    				    <button type="button" onclick="javascript:del();" target="_self" class="btn btn-write" style="float:left">
	    					<i class="fa fa-arrows-alt fa-lg"></i>移动
	    				</button>
	    				<button type="button" id="addTemplate" class="btn btn-add" style="float:left">
				    		<i class="fa fa-retweet"></i>还原密码
				    	</button>
	    				...
	    				<label for="collkeyword_showRelevance" class="x-form-cb-label" style="float:left" id="ext-gen1098">显示子机构用户</label>
	    				<!-- <button type="button" onclick="javascript:del();" target="_self" class="btn btn-write" style="float:left">
		...
		<div class="wf-list-wrap">
			...
			<table id="tab232323" class="wf-fixtable" layoutH="140"  style="width:100%;">
				<thead>
					<tr>
					    <th width="2%"></th>
		    	  		...
		    	  		<th align="center" width="10%">E-mail</th>
		    	  		<th align="center" width="10%">办公电话</th>
		    	  		<th align="center" width="10%">家庭电话</th>
	                </tr>
		    	</thead>
	    		...
	    		<tr>
					...
					<td align="center"  title ="" ><i class="fa fa-search"></i>&nbsp;&nbsp;<i class="fa fa-dedent fa-lg"></i></td>
					<td align="center"  title ="" >曹晓丽</td>
					<td align="center"  title ="" >caoxl</td>
					<td align="center"  title ="" >局长室</td>
					<td align="center"  title ="" ></td>
	    		</tr>
			</table>
		</div>
...
var ctx = "${ctx}";
	layui.extend({
		...
		var dataJson=[{"id":"1","title":"机构设置","parentId":"-1","checkArr":"0","basicData":-1},
		              {"id":"2","title":"如东县档案局","parentId":"1","checkArr":"0","basicData":3833},
		              {"id":"3","title":"如东室系统","parentId":"2","checkArr":"0","basicData":3171},
		              ];
