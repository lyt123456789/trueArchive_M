...
<html>
	...
	<body>
		<div class="layui-tab layui-tab-brief" lay-filter="statistics">
			  ...
			  <ul class="layui-tab-title">
			  			<li lay-id="project" class="layui-this">定义字段</li>
			  			<li lay-id="file" class="layui-this">调整字段顺序</li>
					...
					<form id="thisForm" method="POST" name="thisForm" action="" >
						<table class="wf-fixtable" id="dataTable" layoutH="140"  style="width: 100%;">
							<thead>
			                    ...
			                    <th align="center" width="10%">长度</th>
								<th align="center" width="10%">小数位数</th>
								<th align="center" width="8%">元数据</th>
			                   	<th align="center" width="8%">是否为可编辑</th>
			                   	<th align="center" width="8%">是否为必填项</th>                  
			                    ...
			                    <tr>
									...
									<td align="center"  title ="" >利用单编号</td>
									<td align="center"  title ="" >文本</td>
									<td align="center"  title ="" >30</td>
									<td align="center"  title ="" >0</td>
									<td align="center"  title ="" >using:usingFromId</td>
									<td align="center"  title ="" >否</td>
									<td align="center"  title ="" >否</td>
