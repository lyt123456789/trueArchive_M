		...
		<div class="wf-list-wrap">
			...
			<table id="tab232323" class="wf-fixtable" layoutH="140"  style="width:100%;">
				<thead>
					<tr>
					    <th width="2%"></th>
		    	  		...
		    	  		<th align="center" width="16%">全宗号</th>
		    	  		<th align="center" width="10%">全宗名称</th>
		    	  		<th align="center" width="10%">档案门类</th>
		    	  		<th align="center" width="12%">数字化起止档号</th>
		    	  		<th align="center" width="10%">案卷_卷</th>
		    	...
		    	<tr>
					...
					<td align="center"  title ="" >2018-08-23</td>
					<td align="center"  title ="" >如东县广播电视局</td>
					<td align="center"  title ="" >2001-2001</td>
					<td align="center"  title ="" ></td>
	    		</tr>
	    		<!-- <tr>
	    		    <td align="center"  title ="" ></td>
...
var ctx = "${ctx}";
	layui.extend({
		...
		var dataJson=[{"id":"1","title":"档案数字化","parentId":"-1","checkArr":"0","basicData":-1},
		              {"id":"2","title":"馆藏档案数字化情况登记表","parentId":"1","checkArr":"0","basicData":3833},
		              {"id":"3","title":"","parentId":"1","checkArr":"0","basicData":3171},
		              ];
