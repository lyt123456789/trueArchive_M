	...
	<div class="wf-list-wrap">
		...
		<table id="tab232323" class="wf-fixtable" layoutH="140"  style="width:100%;">
			<thead>
				<tr>
	    	  		<th width="3%"></th>
	    	  		<th align="center" width="18%">统计方案名称</th>
	    	  		<th align="center" width="12%">运行</th>
	    	  		<th align="center" width="8%">修改</th>
	    	  		<th align="center" width="8%">查看</th>
                   </tr>
	    	</thead>
	    	...
	    	<tr>
				...
				<td align="center"  title ="" >文书开放统计</td>
				<td align="center"  title ="" ><i class="fa fa-file-pdf-o fa-lg"></i>&nbsp;&nbsp;<i class="fa fa-file-excel-o fa-lg"></i>&nbsp;&nbsp;<i class="fa fa-file-word-o fa-lg"></i></td>
				<td align="center"  title ="" ><i class="fa fa-pencil-square-o fa-lg"></i></td>
				<td align="center"  title ="" ><i class="fa fa-search"></i></td>
    		</tr>
		</table>
	</div>
