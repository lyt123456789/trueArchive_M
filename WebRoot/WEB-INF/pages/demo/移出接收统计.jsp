...
<div class="wf-layout" style="height: 60%;">
	<div class="wf-list-top">
		<div class="wf-search-bar">
			<form name="list"  id="list" action="" method="post" style="display:inline-block;width: 100%;">
				<div class="search">
				        <select style="float:left" class="btn btn-add" id="docnumbig" name="parentid">
                		<option value="">移交接收单</option>
     					<option value="DF866F12-6ADD-4956-91CB-9B6E32506149">移交接收库</option>
                        </select>
			    		<!-- <button type="button" id="addTemplate" class="btn btn-add" style="float:left">
				    		<i class="fa fa-upload"></i>移交接收单
				    	</button> -->
				    	<button type="button" id="addTemplate" class="btn btn-add" style="float:left">
	...
	<div class="wf-list-wrap">
		<!-- <div class="loading"></div> --><!--2017-11-10-->
		 <table id="table1" class="wf-fixtable" layoutH="140"  style="width:100%;">
			<thead>
				<tr id="table11">
	    	  		<th width="3%"></th>
	    	...
	    	<tr>
				...
				<td align="center"  title ="" >王美琴</td>
				<td align="center"  title ="" >2015-02-28</td>
				<td align="center"  title ="" >徐洁</td>
				<td align="center"  title ="" >中共如东县党校</td>
				<td align="center"  title ="" >文书档案_件</td>
				<td align="center"  title ="" >已接收</td>
				<td align="center"  title ="" >NO.20181118-000029</td>
				<td align="center"  title ="" >2018-12-11</td>
...
<div class="wf-layout">
	<div class="wf-list-top">
		<div class="wf-search-bar">
			<form name="list"  id="list" action="" method="post" style="display:inline-block;width: 100%;">
				<div class="search">
			    		<div style="float: left;font-size: 16px;line-height: 30px;height: 30px;margin-right: 15px;">统计结果:</div>
	    				<button type="button" onclick="javascript:del();" target="_self" class="btn btn-danger" style="float:left">
	    					<i class="fa fa-server"></i>设置统计方案
	    				</button>
	    				<button type="button" id="addTemplate" class="btn btn-add" style="float:left">
				    		<i class="fa fa-sign-in"></i>导出统计结果
				    	</button>
				    	<%-- <button type="button" id="addTemplate" class="btn btn-add" style="float:left">
	...
	<div class="wf-list-wrap">
		<!-- <div class="loading"><div> --><!--2017-11-10-->
		<%-- <table id="table2" class="wf-fixtable" layoutH="140"  style="width:100%;">
			<thead>
				<tr id="table22">
	    	  		<th width="3%"></th>
