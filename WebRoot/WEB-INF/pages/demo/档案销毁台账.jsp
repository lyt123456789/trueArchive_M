			...
			<table id="tab232323" class="wf-fixtable" layoutH="140"  style="width:100%;">
				<thead>
					<tr>
		    	  		...
		    	  		<th align="center" width="15%">年度</th>
...
var ctx = "${ctx}";
	layui.extend({
		...
		var dataJson=[{"id":"1","title":"档案销毁台账","parentId":"-1","checkArr":"0","basicData":-1},
		              {"id":"2","title":"档案销毁登记簿","parentId":"1","checkArr":"0","basicData":3833},
		              {"id":"3","title":"档案销毁记录","parentId":"1","checkArr":"0","basicData":3171},
		              ];
