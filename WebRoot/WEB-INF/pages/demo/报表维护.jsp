	...
	<div class="wf-list-top">
		<div class="wf-search-bar">
			<form name="lendLingList"  id="lendLingList" action="${ctx }/str_toStructureTempPage.do?a=Math.random();" method="post" style="display:inline-block;width: 100%;">
				<div class="search">
				    <button type="button" id="createTemplate" class="btn btn-add" style="float:left">
			    		<i class="fa fa-gears"></i>下载报表设计器
			    	</button>
    				...
    				<!-- <label style="float:left" class="wf-form-label" for="">选择范围：</label> -->
                      <select style="float:left" class="wf-form-select" id="docnumbig" name="parentid">
                		<option value="">全部</option>
     					<option value="DF866F12">Pdf</option>
     					<option value="B632D4D3">Word</option>
     					<option value="B632D4D3">Excel</option>
                      </select>
    				<div class="fr">
	...
	<div class="wf-list-wrap">
		...
		<table id="tab232323" class="wf-fixtable" layoutH="140"  style="width:100%;">
			<thead>
				<tr>
	    	  		<th width="4%"></th>
	    	  		<th align="center" width="16%">报表标题</th>
	    	  		<th align="center" width="12%">报表格式</th>
	    	  		<th align="center" width="8%">输出格式</th>
	    	  		<th align="center" width="12%">报表模板文件</th>
	    	  		<th align="center" width="12%">上传者</th>
	            </tr>
	    	</thead>
	    	...
	    	<tr>
	    			<td align="center" >
						<input type="checkbox"  name="strTemplate"  value="11" class="check_view_state" id="11" style="display: none;">
						<label for="11"></label>
					</td>
					<td align="center"  title ="" >借阅利用（PDF）</td>
					<td align="center"  title ="" >复合报表</td>
					<td align="center"  title ="" >Pdf</td>
					<td align="center"  title ="" >已存在</td>
