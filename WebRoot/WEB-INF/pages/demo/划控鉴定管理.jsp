				...
				<thead>
					<tr>
					    <th width="2%"></th>
		    	  		...
		    	  		<th align="center" width="15%">档案起止年度</th>
		    	  		<th align="center" width="10%">档案数量_案卷数</th>
...
var ctx = "${ctx}";
	layui.extend({
		...
		var dataJson=[{"id":"1","title":"划控鉴定管理","parentId":"-1","checkArr":"0","basicData":-1},
		              {"id":"2","title":"如东县档案馆满三十年档案划控","parentId":"1","checkArr":"0","basicData":3833},
