			...
			<table id="tab232323" class="wf-fixtable" layoutH="140"  style="width:100%;">
				<thead>
					<tr>
		    	  		...
		    	  		<th align="center" width="10%">收进日期</th>
...
var ctx = "${ctx}";
	layui.extend({
		...
		var dataJson=[{"id":"1","title":"接收移出台账","parentId":"-1","checkArr":"0","basicData":-1},
		              {"id":"2","title":"档案收进登记簿","parentId":"1","checkArr":"0","basicData":3833},
		              {"id":"3","title":"如东县档案部全宗名册","parentId":"1","checkArr":"0","basicData":3171},
		              ];
