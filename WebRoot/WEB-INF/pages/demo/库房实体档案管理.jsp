...
<div style="position:relative;">
	...
	<div id="editDiv">
		...
		<div class="wf-list-wrap">
			...
			<fieldset id="ext-comp-1903" class=" x-fieldset " style="width: auto;">
			 <legend><i class="fa fa-caret-square-o-up fa-lg"></i></legend>
			 
			  <div class="x-form-item floatLeft" tabindex="-1">
			                     名称:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			       <input type="text" size="20" autocomplete="off"  name="pkg.名称" value="档案保管管理" class=" x-form-text x-form-field" readonly="" style="color: gray; opacity: 0.6; border: 2px solid rgb(204, 204, 204); width: 210px;">             
			                     代码:
			       <input type="text" size="20" autocomplete="off" value="1" class=" x-form-text x-form-field" readonly="" style="color: gray; opacity: 0.6; border: 2px solid rgb(204, 204, 204); width: 210px;">
			                     是否树上节点:
			       <input type="text" size="20" autocomplete="off" value="true"  name="pkg.开放与控制" class=" x-form-text x-form-field" readonly="" style="color: gray; opacity: 0.6; border: 2px solid rgb(204, 204, 204); width: 210px;">
			  </div>
			  <div class="x-form-item floatLeft" tabindex="-1"  style="padding-top: 10px;">
			                     图标:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			       <input type="text" size="20" autocomplete="off"  name="pkg.图标" value="./images/repositoryArea.png" class=" x-form-text x-form-field" readonly="" style="color: gray; opacity: 0.6; border: 2px solid rgb(204, 204, 204); width: 210px;">             
			                     坐标:
			       <input type="text" size="20" autocomplete="off" name="pkg.坐标" value="803,338" class=" x-form-text x-form-field" readonly="" style="color: gray; opacity: 0.6; border: 2px solid rgb(204, 204, 204); width: 210px;">
	...
	<div class="wf-layout">
	      <div style="float: left;font-size: 16px;line-height: 30px;height: 30px;margin-right: 15px;"><i class="fa fa-list-alt"></i>库房</div>
		<div class="wf-list-top">
			<div class="wf-search-bar">
				<form name="list"  id="list" action="" method="post" style="display:inline-block;width: 100%;">
					<div class="search">
		...
		<div class="wf-list-wrap">
			...
			<table id="tab232323" class="wf-fixtable" layoutH="140"  style="width:100%;">
				<thead>
					<tr>
					    <th width="2%"></th>
		    	  		...
		    	  		<th align="center" width="18%">名称</th>
		    	  		<th align="center" width="13%">isOfCatalog</th>
		    	  		<th align="center" width="13%">代码</th>
		    	  		<th align="center" width="13%">icon</th>
		    	  		<th align="center" width="12%">开放与控制</th>
		    	  		<th align="center" width="12%">开放范围</th>
		    	...
		    	<tr>
					...
					<td align="center"  title ="" >民生档案库房</td>
					<td align="center"  title ="" >true</td>
					<td align="center"  title ="" >02</td>
					<td align="center"  title ="" >./images/repositoryArea.png</td>
...
var ctx = "${ctx}";
	layui.extend({
		...
		var dataJson=[{"id":"1","title":"档案库房实体管理","parentId":"-1","checkArr":"0","basicData":-1},
		              {"id":"2","title":"如东县档案馆","parentId":"1","checkArr":"0","basicData":3833},
		              {"id":"3","title":"民生档案库房","parentId":"2","checkArr":"0","basicData":3171},
		              {"id":"4","title":"文书档案库房","parentId":"2","checkArr":"0","basicData":3171},
		              {"id":"5","title":"专门档案库房","parentId":"2","checkArr":"0","basicData":3171},
		              ];
