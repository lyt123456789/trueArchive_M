...
<div style="position:relative;">
	...
	<div class="layui-tab layui-tab-brief" lay-filter="statistics">
			  ...
			  <ul class="layui-tab-title">
			  			<li lay-id="project" class="layui-this">全文索引库管理</li>
			  			<li lay-id="file" class="layui-this">目录索引库管理</li>
	...
	<div id="editDiv">
		...
		<div class="wf-list-top">
		  <div style="float: left;font-size: 16px;line-height: 30px;height: 30px;margin-right: 15px;"><i class="fa fa-list-alt"></i>已创建索引库的节点</div>
			<div class="wf-search-bar">
				<form name="list"  id="list" action="" method="post" style="display:inline-block;width: 100%;">
					<div class="search">
    				    ...
    				    <button type="button" onclick="javascript:del();" target="_self" class="btn btn-danger" style="float:left">
    					    <i class="fa fa-cart-arrow-down fa-lg"></i>清空
    				    </button>
				    	<button type="button" onclick="javascript:update();" target="_self" class="btn btn-write" style="float:left">
			    		    <i class="fa fa-toggle-up fa-lg"></i>优化索引库
			    	    </button>
				    	<button type="button" onclick="javascript:del();" target="_self" class="btn btn-danger" style="float:left">
    					    <i class="fa fa-external-link fa-lg"></i>重建索引
    				    </button>
		...
		<div class="wf-list-wrap">
			...
			<table id="tab232323" class="wf-fixtable" layoutH="140"  style="width:100%;">
				<thead>
					<tr>
		    	  		<th width="3%"></th>
		    	  		<th align="center" width="25%">节点的名称</th>
		    	  		<th align="center" width="25%">索引库路径</th>
		    	...
		    	<tr>
					...
					<td align="center"  title ="" >/如东县档案局/电子档案</td>
					<td align="center"  title ="" >e:/fullindex/db/2253_1/index</td>
	...
	<div class="wf-layout">
		<div class="wf-list-top">
		  <div style="float: left;font-size: 16px;line-height: 30px;height: 30px;margin-right: 15px;"><i class="fa fa-list-alt"></i>未创建索引库的节点</div>
			<div class="wf-search-bar">
				<form name="list"  id="list" action="" method="post" style="display:inline-block;width: 100%;">
					<div class="search">
				    	<button type="button" onclick="javascript:update();" target="_self" class="btn btn-write" style="float:left">
			    		<i class="fa fa-plus-square fa-lg"></i>创建索引库
			    	    </button>
				    	<button type="button" onclick="javascript:del();" target="_self" class="btn btn-danger" style="float:left">
    					    <i class="fa fa-rotate-right fa-lg"></i>创建所有库
    				    </button>
    				    <!-- <button type="button" onclick="javascript:del();" target="_self" class="btn btn-write" style="float:left">
		...
		<div class="wf-list-wrap">
			...
			<table id="tab232323" class="wf-fixtable" layoutH="140"  style="width:100%;">
				<thead>
					<tr>
		    	  		<th width="3%"></th>
		    	  		<th align="center" width="20%">节点的名称</th>
		    	...
		    	<tr>
					...
					<td align="center"  title ="" >	/如东县档案局/测试 </td>
					<td align="center"  title ="" ></td>
