		...
		<div class="wf-list-wrap">
			...
			<table id="tab232323" class="wf-fixtable" layoutH="140"  style="width:100%;">
				<thead>
					<tr>
					    <th width="2%"></th>
		    	  		...
		    	  		<th align="center" width="10%">修裱时间</th>
		    	  		<th align="center" width="10%">全宗号</th>
		    	  		<th align="center" width="15%">全宗名称</th>
		    	...
		    	<tr>
					...
					<td align="center"  title ="" >2018-12-14</td>
					<td align="center"  title ="" >E123</td>
					<td align="center"  title ="" >测试单位</td>
					<td align="center"  title ="" >E123-2018-0001-0001</td>
	    		</tr>
	    		<tr>
	    		    <td align="center"  title ="" ></td>
	    			<td align="center" >
...
var ctx = "${ctx}";
	layui.extend({
		...
		var dataJson=[{"id":"1","title":"修裱管理","parentId":"-1","checkArr":"0","basicData":-1},
		              {"id":"2","title":"档案修裱登记","parentId":"1","checkArr":"0","basicData":3833},
		              {"id":"3","title":"档案记录","parentId":"1","checkArr":"0","basicData":3171},
		              ];
