...
<div class="wf-layout">
				    ...
				    <label style="float:left" class="wf-form-label" for="">选择范围：</label>
                      <select style="float:left" class="wf-form-select" id="docnumbig" name="parentid">
                		<option value="">--自定义--</option>
     					<option value="DF866F12-6ADD-4956-91CB-9B6E32506149">系统默认</option>
     					<option value="B632D4D3-862C-4685-B821-92F145ADBB0A"></option>
                      </select>
	...
	<div class="wf-list-wrap">
		...
		<table id="tab232323" class="wf-fixtable" layoutH="140"  style="width:100%;">
			<thead>
				<tr>
	    	  		<th width="3%"></th>
	    	  		<th align="center" width="14%">配置名称</th>
	    	  		<th align="center" width="14%">配置键值</th>
	    	  		<th align="center" width="24%">配置值</th>
	    	  		<th align="center" width="14%">配置的描述</th>
                   </tr>
	    	</thead>
	    	...
	    	<tr>
				...
				<td align="center"  title ="" >系统自启动</td>
				<td align="center"  title ="" >AUTOSTART</td>
				<td align="center"  title ="" >系统自启动设置项</td>
	...
	window.onload=function(){ 
		//获得后台分页相关参数-必须
		skipUrl="<%=request.getContextPath()%>"+"/demos_toHujblpzJsp.do";			//提交的url,必须修改!!!*******************
