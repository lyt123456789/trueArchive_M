	...
	<div id="editDiv">
		...
		<div class="wf-list-top">
			<div class="wf-search-bar">
			  <div style="float: left;font-size: 16px;line-height: 30px;height: 30px;margin-right: 15px;"><i class="fa fa-list-alt"></i>日志类型</div>
		...
		<div class="wf-list-wrap">
			...
			<table id="tab232323" class="wf-fixtable" layoutH="140"  style="width:100%;">
				<thead>
					<tr>
					    <th width="2%"></th>
		    	  		...
		    	  		<th align="center" width="10%">日志状态</th>
	    		...
	    		<tr>
					...
					<td align="center"  title ="" >用户登录日志</td>
					<td align="center"  title ="" >记录日志</td>
					<td align="center"  title ="" ></td>
					<td align="center"  title ="" ></td>
					<td align="center"  title ="" ></td>
	    		</tr>
...
var ctx = "${ctx}";
	layui.extend({
		...
		var dataJson=[{"id":"1","title":"日志类型","parentId":"-1","checkArr":"0","basicData":-1},
		              {"id":"2","title":"功能访问日志","parentId":"1","checkArr":"0","basicData":3833},
		              {"id":"3","title":"功能操作日志","parentId":"1","checkArr":"0","basicData":3171},
		              ];
