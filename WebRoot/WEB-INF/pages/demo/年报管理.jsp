...
<div style="position:relative;">
	...
	<div id="editDiv">
		<div class="wf-layout" >
		<div style="float: left;font-size: 16px;line-height: 30px;height: 30px;margin-right: 15px;"><i class="fa fa-list-alt"></i>数据列表</div>
			...
			<div class="wf-search-bar">
				<form name="list"  id="list" action="" method="post" style="display:inline-block;width: 100%;">
					<div class="search">
    				    ...
    				    <button type="button" id="addTemplate" class="btn btn-add" style="float:left">
				    		<i class="fa fa-sign-in"></i>年报导出
				    	</button>
				    	<button type="button" id="addTemplate" class="btn btn-add" style="float:left">
				    		<i class="fa fa-cogs"></i>设置对应
				    	</button>
				    	<button type="button" id="addTemplate" class="btn btn-add" style="float:left">
			    		<i class="fa fa-arrow-circle-down"></i>年报导入
			    	    </button>
	    				<%-- <button type="button" id="addTemplate" class="btn btn-add" style="float:left">
	    				...
	    				<button type="button" onclick="javascript:del();" target="_self" class="btn btn-write" style="float:left">
	    					<i class="fa fa-line-chart fa-lg"></i>统计台账
	    				</button>
	    				<button type="button" onclick="javascript:del();" target="_self" class="btn btn-write" style="float:left">
	    					<i class="fa fa-server fa-lg"></i>批量操作
	    				</button>
	    				<div class="fr">
			...
			<table id="tab232323" class="wf-fixtable" layoutH="140"  style="width:100%;">
				<thead>
					<tr>
					    <th width="2%"></th>
		    	  		<th width="3%"></th>
		    	  		<th align="center" width="10%">编辑内容</th>
		    	  		<th align="center" width="10%">年度</th>
		    	  		<th align="center" width="10%">填报单位</th>
		    	  		<th align="center" width="15%">填表人</th>
		    	  		<th align="center" width="10%">填报日期</th>
		    	  		<!-- <th align="center" width="10%">空调</th>
		    	  		<th align="center" width="10%">档案归库</th>
		    	  		<th align="center" width="10%">管理人</th>
		    	...
		    	<tr>
					...
					<td align="center"  title ="" >2018</td>
					<td align="center"  title ="" >如东县档案局</td>
					<td align="center"  title ="" >administratoradmin</td>
					<td align="center"  title ="" >2014-03-26</td>
	    		</tr>
	    		<!-- <tr>
	    		    <td align="center"  title ="" ></td>
	    			<td align="center" >
						<input type="checkbox"  name="checkbox"  value="11" class="check_view_state" id="12" style="display: none;">
						<label for="11"></label>
					</td>
					<td align="center"  title ="" ><i class="fa fa-dedent fa-lg"></i></td>
					<td align="center"  title ="" >20181216</td>
					<td align="center"  title ="" >D017</td>
					<td align="center"  title ="" >如东县广播电视局</td>
					<td align="center"  title ="" >D017-2001-001-0019</td>
	    		</tr> -->
			</table>
		</div>
...
var ctx = "${ctx}";
	layui.extend({
		...
		var dataJson=[{"id":"1","title":"年报目录树","parentId":"-1","checkArr":"0","basicData":-1},
		              {"id":"2","title":"2018年报","parentId":"1","checkArr":"0","basicData":3833},
		              {"id":"3","title":"2019年报","parentId":"1","checkArr":"0","basicData":3171},
		              ];
