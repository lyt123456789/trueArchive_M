		...
		<div class="wf-search-bar">
			<form name="list"  id="list" action="" method="post" style="display:inline-block;width: 100%;">
				<div class="search">
				    ...
				    <button type="button" id="addTemplate" class="btn btn-add" style="float:left">
				    		<i class="fa fa-sitemap"></i>目录树授权
				    </button>
				    <select style="float:left" class="wf-form-select" id="docnumbig" name="parentid">
                		<option value="">档案利用类</option>
     					<option value="DF866F12">档案管理类</option>
	...
	<div class="wf-list-wrap">
		...
		<table id="tab232323" class="wf-fixtable" layoutH="140"  style="width:100%;">
			<thead>
				<tr>
				    <th width="2%"></th>
	    	  		...
	    	  		<th align="center" width="18%">角色描述</th>
	    	  		<th align="center" width="10%">角色类型</th>
	    	  		<th align="center" width="12%">所属机构</th>
	    	...
	    	<tr>
				...
				<td align="center"  title ="" ><i class="fa fa-simplybuilt fa-lg"></i>&nbsp;&nbsp;
				<i class="fa fa-share-alt fa-lg"></i>&nbsp;&nbsp;<i class="fa fa-steam-square fa-lg"></i></td>
				<td align="center"  title ="" >outxxl</td>
				<td align="center"  title ="" >资源建设科之外</td>
				<td align="center"  title ="" >功能管理类</td>
