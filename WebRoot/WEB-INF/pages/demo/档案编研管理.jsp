...
<div style="position:relative;">
	...
	<div id="editDiv">
		<div class="wf-layout" >
		<div style="float: left;font-size: 16px;line-height: 30px;height: 30px;margin-right: 15px;"><i class="fa fa-list-alt"></i>编研主题列表</div>
			...
			<div class="wf-search-bar">
				<form name="list"  id="list" action="" method="post" style="display:inline-block;width: 100%;">
					<div class="search">
	    				...
	    				<button type="button" id="addTemplate" class="btn btn-add" style="float:left">
				    		<i class="fa fa-search"></i>查找素材
				    	</button>
				    	<button type="button" id="addTemplate" class="btn btn-add" style="float:left">
				    		<i class="fa fa-share-square-o"></i>发布
				    	</button>
				    	<button type="button" id="addTemplate" class="btn btn-add" style="float:left">
				    		<i class="fa fa-reply-all"></i>取消发布
				    	</button>
				    	<button type="button" id="addTemplate" class="btn btn-add" style="float:left">
	    				...
	    				<!-- <button type="button" onclick="javascript:del();" target="_self" class="btn btn-write" style="float:left">
	    					<i class="fa fa-barcode fa-lg"></i>温湿度图形展现
	    				</button> -->
	    				<!-- <button type="button" onclick="javascript:del();" target="_self" class="btn btn-write" style="float:left">
		...
		<div class="wf-list-wrap">
			...
			<table id="tab232323" class="wf-fixtable" layoutH="140"  style="width:100%;">
				<thead>
					<tr>
					    <th width="2%"></th>
		    	  		...
		    	  		<th align="center" width="10%">isOfCatalog</th>
		    	  		<th align="center" width="15%">开放与控制</th>
		    	  		<th align="center" width="10%">开放范围</th>
		    	...
		    	<tr>
					...
					<td align="center"  title ="" ><i class="fa fa-chain-broken fa-lg"></i><i class="fa fa-arrow-up fa-lg"></i><i class="fa fa-dedent fa-lg"></i></td>
					<td align="center"  title ="" >专题目录</td>
	    		...
	    		<!-- <tr>
					...
					<td align="center"  title ="" >D019</td>
					<td align="center"  title ="" >如东县广播电</td>
					<td align="center"  title ="" ></td>
					<td align="center"  title ="" ></td>
	    		</tr> -->
			</table>
...
var ctx = "${ctx}";
	layui.extend({
		...
		var dataJson=[{"id":"1","title":"档案编研管理","parentId":"-1","checkArr":"0","basicData":-1},
		              {"id":"2","title":"专题目录","parentId":"1","checkArr":"0","basicData":3833},
		              {"id":"3","title":"大事记","parentId":"1","checkArr":"0","basicData":3171},
		              ];
