...
<div style="position:relative;">
	...
	<div class="wf-layout">
	      <div style="float: left;font-size: 16px;line-height: 30px;height: 30px;margin-right: 15px;"><i class="fa fa-list-alt"></i>档案保管类型</div>
		<div class="wf-list-top">
			<div class="wf-search-bar">
				<form name="list"  id="list" action="" method="post" style="display:inline-block;width: 100%;">
					<div class="search">
		...
		<div class="wf-list-wrap">
			...
			<table id="tab232323" class="wf-fixtable" layoutH="140"  style="width:100%;">
		    	...
		    	<tr>
					...
					<td align="center"  title ="" >馆藏档案破损、褪变登记</td>
...
var ctx = "${ctx}";
	layui.extend({
		...
		var dataJson=[{"id":"1","title":"档案保管管理","parentId":"-1","checkArr":"0","basicData":-1},
		              {"id":"2","title":"馆藏档案破损，蜕变登记","parentId":"1","checkArr":"0","basicData":3833},
		              {"id":"3","title":"档案虫情及保护措施登记","parentId":"1","checkArr":"0","basicData":3171},
		              ];
