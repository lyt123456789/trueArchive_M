			...
			<table id="tab232323" class="wf-fixtable" layoutH="140"  style="width:100%;">
				<thead>
					<tr>
		    	  		...
		    	  		<th align="center" width="10%">库号</th>
		    	  		<th align="center" width="15%">电灯</th>
		    	  		<th align="center" width="10%">门窗</th>
		    	...
		    	<tr>
					...
					<td align="center"  title ="" >打开</td>
					<td align="center"  title ="" >close</td>
	    		</tr>
	    		<tr>
	    			<td align="center" >
						<input type="checkbox"  name="checkbox"  value="11" class="check_view_state" id="11" style="display: none;">
					...
					<td align="center"  title ="" >关闭</td>
					<td align="center"  title ="" >open</td>
	    		</tr>
			</table>
		</div>
...
var ctx = "${ctx}";
	layui.extend({
		...
		var dataJson=[{"id":"1","title":"库房管理台账","parentId":"-1","checkArr":"0","basicData":-1},
		              {"id":"2","title":"库房管理情况记录表","parentId":"1","checkArr":"0","basicData":3833},
		              {"id":"3","title":"库房温湿度表","parentId":"1","checkArr":"0","basicData":3171},
		              ];
