...
<div class="wf-layout">
	<div class="wf-list-top">
			<form  id="numUnused" name="numUnused"  action="${curl}/docNumber_getDocNumUnused.do?isMobile=1" method="post">
				<div class="searchBar" >
				</div>
	...
	<c:if test="${bwlist ne null}">
			<div class="wf-list-wrap">
				<form id="thisForm" name="thisForm" action="${curl}/docNumber_getDocNumUnused.do?isMobile=1"  method="post" >
		           ...
		           <p>您还可以选择下列暂未使用的文号：</p>
           			<ul class="titanic-list-li clearfix">		            
		                <c:forEach items="${bwlist}" var="bw" varStatus="status">
							<li data-num="${bw.bwxh}">${bw.bwlx}[${bw.bwnh}]${bw.bwxh}号</li>
						</c:forEach>
		            </ul>
		        </div>
				</form>
		           ...
		           <p>您还可以选择下列暂未使用的文号：</p>
           			<ul class="titanic-list-li clearfix">
		                ...
		                <c:forEach items="${fwlist}" var="fw" varStatus="status">
							<li data-num="${fw.fwxh}">${fw.jgdz}[${fw.fwnh}]${fw.fwxh}号</li>
							<!-- <dd class="clearfix">
...
<script src="${curl}/docStatic/js/fontSize.js" type="text/javascript"></script>
...
<script>
	 ...
	 $(document).ready(function(){
		...
		//获得后台分页相关参数-必须
		skipUrl="<%=request.getContextPath()%>"+"/docNumber_getDocNumUnused.do?isMobile=1";			//提交的url,必须修改!!!*******************
	    ...
	    var ch = $(".titanic-choose-area").height();
	    $(".titanic-list-li").height(wh - hh - ch - 158);
</script>
<script type="text/javascript">
	$(function(){
		  $(".titanic-list-li li").bind("click", function() {
		        $(this).addClass("on").siblings().removeClass("on");
		        parent.$(".xh-class").val($(this).data("num"));
		    })
	});
</script>
</body>
